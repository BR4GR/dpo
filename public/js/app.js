...
/* harmony import */ var _gutenbergKaraoke_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./gutenbergKaraoke.js */ "./resources/js/gutenbergKaraoke.js");
...
var apps = [_terminal_js__WEBPACK_IMPORTED_MODULE_2__["default"], _gutenbergKaraoke_js__WEBPACK_IMPORTED_MODULE_3__["default"]];
...
/***/ "./resources/js/gutenbergKaraoke.js":
/*!******************************************!*\
  !*** ./resources/js/gutenbergKaraoke.js ***!
  \******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ GutenbergKaraoke)
/* harmony export */ });
...
var GutenbergKaraoke = /*#__PURE__*/function () {
  function GutenbergKaraoke() {
    _classCallCheck(this, GutenbergKaraoke);
    // Cache DOM elements
    this.$displayArea = jquery__WEBPACK_IMPORTED_MODULE_0__('#displayArea');
    this.$bookInfo = jquery__WEBPACK_IMPORTED_MODULE_0__('#bookInfo');
    this.$errorEl = jquery__WEBPACK_IMPORTED_MODULE_0__('#error');
    this.$speedSlider = jquery__WEBPACK_IMPORTED_MODULE_0__('#speed');
    this.$chapterSelect = jquery__WEBPACK_IMPORTED_MODULE_0__('#chapterSelect');
    this.$jumpBackBtn = jquery__WEBPACK_IMPORTED_MODULE_0__('#jumpBackBtn');
   ...
   */
  return _createClass(GutenbergKaraoke, [{
    key: "initializeEvents",
    value: function initializeEvents() {
      var _this = this;
      this.$speedSlider.on('input', function () {
        _this.currentWPM = parseInt(_this.$speedSlider.val(), 10);
        _this.updateIntervalDuration();
      });
      this.$chapterSelect.on('change', function () {
        var selectedChapterIndex = parseInt(_this.$chapterSelect.val(), 10);
        if (_this.chapters && _this.chapters[selectedChapterIndex]) {
          _this.setChapter(selectedChapterIndex);
        }
      });
      this.$jumpBackBtn.on('click', function () {
        _this.jumpBack(50);
      });
    }
    ...
    key: "updateIntervalDuration",
    value: function updateIntervalDuration() {
      var _this2 = this;
      var msPerWord = 60000 / this.currentWPM;
    ...
    key: "fetchBookFromBackend",
    value: (function () {
      var _fetchBookFromBackend = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var response, data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 11:
              // Update book info
              this.$bookInfo.text("".concat(data.title, " by ").concat(data.authors.map(function (a) {
                return a.name;
              }).join(', '), " (ID: ").concat(data.bookID, ")"));
            ...
            case 17:
              ...
              this.$errorEl.text("Error: " + _context.t0.message);
              this.$bookInfo.text("");
            case 21:
            case "end":
      ...
      function fetchBookFromBackend() {
        return _fetchBookFromBackend.apply(this, arguments);
      }
      return fetchBookFromBackend;
    }()
    /**
    ...
    key: "populateChapterSelect",
    value: function populateChapterSelect() {
      var _this3 = this;
      this.$chapterSelect.empty();
      this.chapters.forEach(function (ch, index) {
        var $option = jquery__WEBPACK_IMPORTED_MODULE_0__('<option>').val(index).text(ch.title);
        _this3.$chapterSelect.append($option);
      });
    }
    ...
    key: "setChapter",
    value: function setChapter(chapterIndex) {
      if (!this.chapters || !this.chapters[chapterIndex]) return;
      var chapterText = this.chapters[chapterIndex].text;
    ...
    key: "jumpBack",
    value: function jumpBack(numWords) {
    ...
    key: "applies",
    value: function applies() {
      return jquery__WEBPACK_IMPORTED_MODULE_0__('#displayArea').length > 0 && jquery__WEBPACK_IMPORTED_MODULE_0__('#bookInfo').length > 0;
    }
  }]);
}();
...
var _$commandInput = /*#__PURE__*/new WeakMap();
var _$searchModal = /*#__PURE__*/new WeakMap();
var DpoTerminal = /*#__PURE__*/function () {
  function DpoTerminal() {
    _classCallCheck(this, DpoTerminal);
    // Class variables.
    _classPrivateFieldInitSpec(this, _$commandInput, void 0);
    _classPrivateFieldInitSpec(this, _$searchModal, void 0);
  ...
  return _createClass(DpoTerminal, [{
    ...
    key: "initializeSearchModal",
    value: function initializeSearchModal() {
      _classPrivateFieldSet(_$searchModal, this, jquery__WEBPACK_IMPORTED_MODULE_0__('<div id="search-modal"></div>').css('display', 'none'));
      jquery__WEBPACK_IMPORTED_MODULE_0__('body').append(_classPrivateFieldGet(_$searchModal, this));
    }
    ...
    value: function initializeEventListeners() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0__('a').on('click', function () {
          setTimeout(function () {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', function (e) {
          if (_classPrivateFieldGet(_$searchModal, _this).is(':visible') && !jquery__WEBPACK_IMPORTED_MODULE_0__(e.target).closest('#search-modal, #command-input').length) {
            _this.closeSearchModal();
          }
        });
        jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('keydown', function (e) {
          if (e.key === "Escape" && _classPrivateFieldGet(_$searchModal, _this).is(':visible')) {
            _this.closeSearchModal();
          }
        });
      });
    ...
    key: "focusOnCommandInput",
    value: function focusOnCommandInput() {
      var _this2 = this;
      setTimeout(function () {
        var _classPrivateFieldGet2;
        (_classPrivateFieldGet2 = _classPrivateFieldGet(_$commandInput, _this2)) === null || _classPrivateFieldGet2 === void 0 || _classPrivateFieldGet2.focus();
      }, 100);
    }
    ...
    value: function closeSearchModal() {
      _classPrivateFieldGet(_$searchModal, this).hide();
      _classPrivateFieldGet(_$searchModal, this).html(""); // Clear results
    }
    ...
    value: function updateTerminalPath() {
      ...
      var $terminalPromptElement = jquery__WEBPACK_IMPORTED_MODULE_0__(".terminal-prompt");
        ...
        if (_classPrivateFieldGet(_$commandInput, this).length) {
          _classPrivateFieldGet(_$commandInput, this).on('keyup', function (e) {
            if (e.key === "Enter") {
              ...
              _this4.performLiveSearch(_classPrivateFieldGet(_$commandInput, _this4).text().trim());
            }
          });
        }
      }
    ...
    function applies() {
      return jquery__WEBPACK_IMPORTED_MODULE_0__('.terminal-prompt').length > 0;
    }
  }]);
}();
