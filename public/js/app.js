...
/* harmony import */ var _gutenbergKaraoke_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./gutenbergKaraoke.js */ "./resources/js/gutenbergKaraoke.js");
/* harmony import */ var _terminal_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./terminal.js */ "./resources/js/terminal.js");
...
var apps = [_terminal_js__WEBPACK_IMPORTED_MODULE_3__["default"], _gutenbergKaraoke_js__WEBPACK_IMPORTED_MODULE_2__["default"]];
...
var GutenbergKaraoke = /*#__PURE__*/function () {
  function GutenbergKaraoke() {
    ...
    this.$speedLabel = jquery__WEBPACK_IMPORTED_MODULE_0__('#speedLabel');
    this.$stopBtn = jquery__WEBPACK_IMPORTED_MODULE_0__('#stopBtn');
    this.$startBtn = jquery__WEBPACK_IMPORTED_MODULE_0__('#startBtn');
  ...
  return _createClass(GutenbergKaraoke, [{
    ...
    value: function initializeEvents() {
      ...
      this.$startBtn.on('click', function () {
        return _this.startReading();
      });

      // Stop reading
      this.$stopBtn.on('click', function () {
        return _this.stopReading();
      });
    }
  }, {
    key: "fetchBookFromBackend",
    value: function fetchBookFromBackend() {
      var _this2 = this;
      fetch('/gutenberg/fetch').then(function (res) {
        return res.json();
      }).then(function (data) {
        _this2.$bookInfo.text("".concat(data.title, " by ").concat(data.authors.map(function (a) {
          return a.name;
        }).join(', ')));
        _this2.processText(data.text);
      })["catch"](function (err) {
        return _this2.$errorEl.text("Error: " + err.message);
      });
    }
  }, {
    key: "processText",
    value: function processText(rawText) {
      // Start from "START OF THE PROJECT GUTENBERG EBOOK"
      var startIndex = rawText.indexOf("START OF THE PROJECT GUTENBERG EBOOK");
      var cleanText = rawText.slice(startIndex).replace(/\s+/g, ' ').trim();
    ...
    value: function updateInterval() {
      ...
      this.$speedLabel.text("Speed: ".concat(this.currentWPM, " WPM"));
    }
  }, {
    key: "showNextWord",
    ...
    value: function applies() {
      return jquery__WEBPACK_IMPORTED_MODULE_0__('#displayArea').length > 0;
    }
  }]);
}();
